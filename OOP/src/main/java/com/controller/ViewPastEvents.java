...
public class ViewPastEvents extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uname = (String) session.getAttribute("username"); //Get session if from the form
		...
		RequestDispatcher rd = 	request.getRequestDispatcher("EventsThanuka.jsp"); //Redirecting to the Events Page
